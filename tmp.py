...
class FeedData(bt.feeds.GenericCSVData):
    ...
    params = (
        ...
        ("todate",datetime.datetime(2022,8,30)),
        ('nullvalue', float('0')),
        ('dtformat', '%Y-%m-%d'),
        # ('tmformat', '%H:%M:%S'),
        ('datetime', 1),
